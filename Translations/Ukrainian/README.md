...
* Що Вам найбільше подобається у Ваших інструментах розробника?
* У Вас є якісь особисті проекти?
* Візьміть аркуш паперу і напишіть у стовпчик букви A B C D E. Тепер відсортуйте стовпчик в алфавітному порядку за спаданням, не написавши жодного рядка коду.
